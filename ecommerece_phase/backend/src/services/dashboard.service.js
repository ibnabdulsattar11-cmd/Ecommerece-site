...
export { getSummary, getRevenueTimeseries, getTopProducts, getRecentOrders, getLowStockProducts };
export default { getSummary, getRevenueTimeseries, getTopProducts, getRecentOrders, getLowStockProducts };
...
const adjustStock = async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, { stock: target.stock, log }, "Stock updated"));
};
...
const getHistory = async (req, res) => {
  ...
  const { rows, count } = await inventoryService.getInventoryHistory(
...
export { listInventory, listLowStock, adjustStock, getHistory };
export default { listInventory, listLowStock, adjustStock, getHistory };
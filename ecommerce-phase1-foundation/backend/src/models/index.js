...
Coupon.belongsToMany(Product, { through: "coupon_products", foreignKey: "couponId" });
Product.belongsToMany(Coupon, { through: "coupon_products", foreignKey: "productId" });

Coupon.belongsToMany(Category, { through: "coupon_categories", foreignKey: "couponId" });
Category.belongsToMany(Coupon, { through: "coupon_categories", foreignKey: "categoryId" });

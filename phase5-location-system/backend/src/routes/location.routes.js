...
/* ---------------------------- Public ---------------------------- */
router.get("/reverse-geocode", geoLimiter, reverseGeocodeRules, validate, reverseGeocode);
...
router.post("/admin/zones", protect, restrictTo("ADMIN"), zoneRules, validate, createZone);
router.patch("/admin/zones/:id", protect, restrictTo("ADMIN"), zoneRules, validate, updateZone);

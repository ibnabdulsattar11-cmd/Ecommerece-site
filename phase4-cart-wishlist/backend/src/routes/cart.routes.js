...
const { addItemRules, updateQuantityRules } = require('../validators/cart.validator');
...
router.put('/items/:itemId', updateQuantityRules, validate, cartController.updateItemQuantity);
